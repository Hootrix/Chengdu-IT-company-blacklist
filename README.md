...
70. 四川汉科计算机信息技术有限公司
```
   本人并没有入职，在投简历的时候看到这家公司，于是在查企业信息时看到21年因欠钱被列为被执行人。查看了一审，二审的文件后总结如下:
   1. 找各种理由开除员工，二审看到是说‘上班期间浏览与工作无关的网页’，一审说别人早退旷工，结果汉科提不出的证据证明不了。
   2. 叫你签另外的《知情同意书》同意加班工资为15元/时，结果一审的时候是按照劳动法让公司按照一倍补齐了（结果没有按照1.5倍补？）
   3. 公司内部各种调岗(二审部分提及), 开发调测试等
...
71.四川融创志民传媒科技有限公司(仁怀市时代梦企业管理有限公司)
```
1. 面试通过后不发offer 直接喊试岗 试岗通过后只签试用期合同 试用期合同上只有试用期工资(等于说你不到转正压根不知道你的实际工资) 试用期不买社保
2. 面试的时候说的1-3个月可申请提前转正 满一个月的时候提申请 老板说至少要两个月 等满两个月的时候又说必须满三个月
3. 绩效乱扣, 公司不招测试, 前端出的bug连同后端一起扣绩效
4. 项目之前外包开发, 刚入职就要承担外包遗留的bug风险, 根本不管是不是你导致的, 只要系统出现bug, 就得扣你的绩效

先把人骗进来 用试用期的廉价工资让你当苦力 毫无诚信可言
!!!!!!!公司不招测试!!!!!!!出任何bug都会成为他们扣绩效的借口!!!!!!
```